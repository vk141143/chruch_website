...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Kingdom Life Fellowship — A Christ-Centered Community" },
      { name: "description", content: "Kingdom Life Fellowship is a Christ-centered church family pursuing worship, the Word of God, and life-giving community." },
      { name: "author", content: "Kingdom Life Fellowship" },
